...
plugins=(git colorize python pip themes colored-man-pages screen vi-mode web-search history-substring-search zsh-autosuggestions zsh-syntax-highlighting command-not-found)

source $ZSH/oh-my-zsh.sh
source ~/.aliases
source ~/.ssh-ensae  # this file is not on git.
